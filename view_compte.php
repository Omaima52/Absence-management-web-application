                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                  <?php if($row['enabled']==1){?>
                                                      <span class="bage badge-success badge-pill small">Activé</span>
                                                    <?php }else{?>
                                                      <span class="bage badge-danger badge-pill small">Désactivé</span>
                                                    <?php }?>
                                                </td>
                                                <td>
                                                  <?php if($row['accountNotLocked']==1){?>
                                                ...
                                                <td>
                                                <?php if($row['accountNotExpired']==1){?>
                                                    <span class="bage badge-primary badge-pill small ">Non expiré</span>
                                                  <?php }else{?>
                                                    <span class="bage badge-secondary badge-pill small ">Expiré</span>
                                                  <?php }?>
                                                </td>
                                                ...
                                                <a href="view_compte.php?idCompte=<?=$row['idCompte'];?>"><button type="button" class="btn btn-xs btn-danger" ><i class="fa fa-trash"></i></button></a>
