...
if(isset($_POST["btn_update"]))
{
    extract($_POST);
      ...
      $q1="UPDATE `coordination` SET `idFiliere`='$idFiliere',`idUtilisateur`='$idUtilisateur',`dateDebut`='$dateDebut', `dateFin`='$dateFin'  WHERE `idCoordination`='".$_GET['idCoordination']."'";

    if ($conn->query($q1) === TRUE) {
      $_SESSION['success']=' Coordination modifiée avec succés';
     ?>
...
<?php
$que="SELECT * from `coordination` WHERE idCoordination='".$_GET["idCoordination"]."'";
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Modifier une coordination</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" name="coordinationform">
                                    ...
                                    <div class="form-group">
                                                 ...
                                                 <div class="col-sm-8">
                                                     <select type="text" name="idUtilisateur" class="form-control"  placeholder="Filière" required="">
                                                         <option value="">--Choisir un enseignant--</option>
                                                             ...
                                                             if ($result->num_rows > 0) {
                                                                 while ($row = mysqli_fetch_array($result)) {?>
                                                                     <option value="<?php echo $row["idUtilisateur"];?>" <?php if($row["idUtilisateur"]==$idUtilisateur){ echo "selected"; } ?>>
                                        ...
                                        <div class="form-group">
                                              <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                  <input type="date" name="dateDebut" class="form-control" placeholder="Saisir la date de début" value="<?php echo date("Y-m-d", strtotime($dateDebut)); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                              <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                  <input type="date" name="dateFin" class="form-control" placeholder="Saisir la date de fin" value="<?php echo date("Y-m-d", strtotime($dateFin)); ?>">
                                                </div>
                                            </div>
                                        </div>
