...
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            <div class="card-body">
                            <a href="add_enseignant.php"><button class="btn btn-primary">Ajouter un enseignant</button></a>
                                   ...
                                   while($row = $result1->fetch_assoc()) {
                                      ?>
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                <a href="edit_enseignant.php?idUtilisateur=<?=$row['idUtilisateur'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-edit"></i></button></a>
                                                <a href="view_enseignant.php?idUtilisateur=<?=$row['idUtilisateur'];?>"><button type="button" class="btn btn-xs btn-danger" ><i class="fa fa-trash"></i></button></a>
