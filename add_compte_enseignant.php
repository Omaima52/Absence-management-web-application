...
extract($_POST);
$sql_et = "SELECT * from enseignant e  join utilisateur u on u.idUtilisateur = e.idUtilisateur where u.cin = '".$_POST["cin"]."' ";
                          ...
                          <form class="form-horizontal" method="POST" action="actions/save_compte.php" name="cneform" >
                             ...
                             <input type="hidden" class="form-control" name="idUtilisateur" value="<?php echo $idUtilisateur_ ?>" >
                                 ...
                                 <div class="form-group">
                                      <div class="row">
                                          <label class="col-sm-4 control-label text-right">Nom de l'enseignant</label>
                                          <div class="col-sm-8">
                                  ...
                                  <div class="form-group">
                                       <div class="row">
                                           <label class="col-sm-4 control-label text-right">Prénom de l'enseignant</label>
                                           <div class="col-sm-8">
                                   ...
                                   <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                              <select type="text" name="idRole" class="form-control"  placeholder="Rôle" required>
                                                  <option value="">--Choisir une rôle--</option>
                                                      ...
                                                      if ($result->num_rows > 0) {
                                                          while ($row = mysqli_fetch_array($result)) {?>
                                                              <option value="<?php echo $row["idRole"];?>" <?php if($row["idRole"]==3){echo " selected";}?>>
