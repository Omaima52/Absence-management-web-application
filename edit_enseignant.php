...
<?php include('sidebar.php');?>
 ...
 if(isset($_POST["btn_update"]))
 {
  ...
  if (move_uploaded_file($_FILES['photo']['tmp_name'], $target)) {
   @unlink("uploadImage/Profile/".$_POST['old_photo']);
       ...
       $q2="UPDATE enseignant SET `specialite`='$specialite 'WHERE `idUtilisateur`='".$_GET['idUtilisateur']."'";

     if ($conn->query($q1) === TRUE) {
       if ($conn->query($q2) === TRUE) {
           $_SESSION['success']=' Enseignant modifié avec succés';
        ?>
 ...
 <?php
$que="SELECT * from enseignant e join utilisateur u  on u.idUtilisateur=e.idUtilisateur  where u.idUtilisateur='".$_GET["idUtilisateur"]."'";
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="specialite" class="form-control" placeholder="Saisir la spécialité" required value="<?=$specialite?>">
                                        </div>
                                    </div>
                                </div>
